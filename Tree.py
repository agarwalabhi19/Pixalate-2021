...
def align(v1,v2):
    ...
    if agl<=-130:
        ...
        for i in range(100):
            p.stepSimulation()
            env.move_husky(-13, -13, 0, 0)
        img1=env.camera_feed()
        #cv2.waitKey(0)
    if agl<=180 and agl>=130:
        for i in range(250):
            p.stepSimulation()
            env.move_husky(-27, 27, -27, 27)
            p.stepSimulation()
...
#----------FOR__PINK------------
    ...
    for cnt in ct_y:
        ...
        if area > 400:
            ...
            pos[int(ceny/y)][int(cenx/x)]=250+500
...
#----------FOR__BLUE------------
        ...
        if area > 400:
            ...
            if(len(approx)==3):
                ...
                count=count+1
                 ...
                 #cv2.fillPoly(img, pts=cnt, color=(0,0,0))
                 pos[int(ceny/y)][int(cenx/x)]=150+500
                 hnode[0]=nodes[int(ceny/y)][int(cenx/x)]
                 
            elif(len(approx)>5):
                 #cv2.fillPoly(img, pts=cnt, color=(0,0,0))
                 pos[int(ceny/y)][int(cenx/x)]=200+500
    ...
    while True:
       ...
       # print(im.shape)
        ...
        sd,no=g.dijkstra(c)
        print("pnode", pnode)
        print("pnode0", sd[pnode[0]]," ",sd[pnode[1]])
        ...
        time.sleep(1)
        print('exiting in 4 sec')
        time.sleep(1)
        print('exiting in 3 sec')
        time.sleep(1)
        print('exiting in 2 sec')
        time.sleep(1)
        print('exiting in 1 sec')
        time.sleep(1)
        break
